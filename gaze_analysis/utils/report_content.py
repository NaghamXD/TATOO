...
FEATURES = {
    ...
    "Flight_Duration_sec": {
        ...
        "unit": "sec",
        "domain": "motor_planning",
        "note": "Time spent moving toward the target before touching it.",
    },
    "Touch_Duration_sec": {
        "label": "Touch Duration",
        "unit": "sec",
        "domain": "motor_planning",
        "note": "Time spent in contact with the screen completing the action.",
    },
    "Flight_Touch_Ratio": {
    ...
    "Pressure_Med_Pct": {
        "label": "% Time at Medium Touch Pressure",
        "unit": "%",
        "domain": "motor_control",
        "note": "Share of the task spent pressing with moderate force.",
    },
    "Pressure_Low_Pct": {
    ...
    "Gaze_Pct_Within_Screen": {
        "label": "% Gaze Within Screen",
        "unit": "%",
        "domain": "visual_attention",
        "note": "Share of the task with gaze on the tablet.",
    },
    "Gaze_Pct_Outside_Screen": {
        "label": "% Gaze Outside Screen",
        "unit": "%",
        "domain": "visual_attention",
        "note": "Share of the task with gaze drifting off the tablet.",
    },
    "Gaze_In_Out_Ratio": {
