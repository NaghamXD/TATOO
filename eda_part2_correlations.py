...
if __name__ == "__main__":
    generate_status_correlation_heatmap('Eldery_Final_ML_Ready.csv', 'Elderly_Correlation_Heatmap.png', 'Elderly')
    generate_status_correlation_heatmap('Children_Final_ML_Ready.csv', 'Children_Correlation_Heatmap.png', 'Children')